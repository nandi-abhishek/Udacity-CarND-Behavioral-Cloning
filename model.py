...
def generate_training_data(image_paths, angles, batch_size=128, validation_flag=False):
    '''
    method for the model training data generator to load, transform and process images, then yield them to the
    model. if 'validation_flag' is true the image is not transformed. also flips images with turning angle magnitudes
    of greater than 0.1
    '''
